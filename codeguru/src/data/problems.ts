    ...
    },
    {
      ...
      },
      {
        ...
        "solutions": {
          ...
          "3": "low",
          "4": "high",
          "5": "helper(root, float('-inf'), float('inf'))",
        },
        "hints": {
      ...
      },
      {
        ...
        "codeLines": [
          ...
          "    curr = _____2_____",
          "    while curr:",
          "        next_temp = _____3_____",
          "        curr.next = _____4_____",
          "        prev = _____5_____",
          "        curr = _____6_____",
          "    return _____7_____"
        ],
        ...
        "hints": {
          "1": "Initialize 'prev' to None to represent the end of the reversed list.",
          "2": "Start 'curr' at the head of the original list.",
          "3": "Temporarily store the next node before changing the link.",
          "4": "Reverse the current node's pointer to point to the previous node.",
          "5": "Move the 'prev' pointer to the current node.",
          "6": "Advance to the next node in the original list.",
          "7": "After the loop, 'prev' will be the new head of the reversed list."
        },
        "topicExplanation": "A linked list is a linear data structure where each element, called a node, contains a value and a reference to the next node in the sequence. In a singly linked list, each node points to the next node, and the last node points to None, indicating the end of the list. To reverse a singly linked list, we need to change the direction of the links between nodes so that each node points to its previous node instead of the next one. This process involves iterating through the list and adjusting the 'next' pointers of each node to point to the previous node. By the end of the iteration, the original head of the list becomes the tail (pointing to None), and the last node becomes the new head of the reversed list."
      },
      {
        "id": "reverse-sub-list",
        ...
        "tags": ["linked-list", "fundamentals", "lc-medium"],
        "codeLines": [
          "class ListNode:",
          "    def __init__(self, val=0, next=None):",
          "        self.val = val",
          ...
          "        return _____1_____",
          "",
          "    current, previous = head, _____2_____",
          "    i = 0",
          ...
          "        next = current.next",
          "        current.next = _____4_____",
          "        previous = current",
          "        current = _____5_____",
          "        i += 1",
          "",
          "    if last_node_of_first_part is not None:",
          "        last_node_of_first_part.next = _____6_____",
          "    else:",
          "        head = previous",
          "",
        ...
        "hints": {
          "1": "If p and q are the same, no changes are needed; return head.",
          "2": "Initialize previous as None since it will track nodes before p.",
          "3": "Move current forward until reaching the p-th node.",
          "4": "Reverse the 'next' pointer of the current node to point to the previous node.",
          "5": "Move to the next node in the sub-list being reversed.",
          "6": "Connect the end of the first part to the reversed sublist.",
          "7": "Return the modified head of the linked list."
        },
        "topicExplanation": "A linked list is a linear data structure where each element (node) contains a value and a reference to the next node in the sequence. To reverse a sublist within a linked list, we must locate the start of the sublist, reverse the pointers within that range, and reconnect the modified sublist to the rest of the list. This operation modifies the list in place without requiring additional memory for a new list."
      },
      {
        "id": "reverse-every-k-element-sublist",
        ...
        "codeLines": [
          ...
          "        next = _____1_____",
          "        current.next = _____2_____",
          "        _____3_____",
          "        current = _____4_____",
          "        _____5_____",
          "      if last_node_of_previous_part is not None:",
          "        last_node_of_previous_part.next = _____6_____",
          "      else:",
          "        head = previous",
          "      last_node_of_sub_list.next = _____7_____",
          "      if current is None:",
          "        break",
        ...
        "hints": {
          ...
          "2": "Set the current node's next pointer to the previous node to reverse the link.",
          "3": "Assign the current node to previous after reversing its pointer.",
          "4": "Move current to the next node that was stored earlier.",
          "5": "Increment the counter to process exactly k nodes.",
          "6": "Reconnect the previous part to the head of the reversed sub-list.",
          "7": "Connect the end of the reversed sub-list to the remaining part of the list."
        },
        "topicExplanation": "This problem involves reversing every k-element sub-list within a linked list. The approach is to iterate through the list in segments of k nodes, reverse the pointers within each segment, and then reconnect the segments appropriately. Even if the last segment has fewer than k nodes, it is still reversed. This technique is a fundamental linked list manipulation and is commonly asked in technical interviews to assess understanding of pointer operations and list traversal."
      },
